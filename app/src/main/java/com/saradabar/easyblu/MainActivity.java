...
public class MainActivity extends Activity {
    ...
    void createFrp() {
        ...
        exec("chown system:shell /dev/block/mmcblk0p24"); 
        exec("mount -o remount,rw /dev/block/mmcblk0p24");
        exec("chmod 777 /dev/block/mmcblk0p24");
        exec("chmod 777 /data/data/com.saradabar.easyblu/files/frp");
        echo("- 通知：frp を修正します。");
        copyAssetsFile(this, FRP);
        echo("- 結果：");
        exec("dd if=/data/data/com.saradabar.easyblu/files/frp of=/dev/block/mmcblk0p24");
        openSettings();
    }
